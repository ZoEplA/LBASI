...
class LexerTestCase(unittest.TestCase):
    def makeLexer(self, text):
        from calc15 import Lexer
        lexer = Lexer(text)
        return lexer

    def test_tokens(self):
        from calc15 import TokenType
        records = (
...
class ParserTestCase(unittest.TestCase):
    def makeParser(self, text):
        from calc15 import Lexer, Parser
        lexer = Lexer(text)
        parser = Parser(lexer)
        return parser

    def test_expression_invalid_syntax_01(self):
        from calc15 import ParserError, ErrorCode
...
class SemanticAnalyzerTestCase(unittest.TestCase):
    def runSemanticAnalyzer(self, text):
        from calc15 import Lexer, Parser, SemanticAnalyzer
        lexer = Lexer(text)
        parser = Parser(lexer)
        tree = parser.parse()
    ...
    def test_semantic_duplicate_id_error(self):
        from calc15 import SemanticError, ErrorCode
...
class InterpreterTestCase(unittest.TestCase):
    def makeInterpreter(self, text):
        from calc15 import Lexer, Parser, SemanticAnalyzer, Interpreter
        lexer = Lexer(text)
        parser = Parser(lexer)
        tree = parser.parse()
